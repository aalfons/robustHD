...
![Examples of the optimality criterion plot (*left*) and the regression diagnostic plot (*right*) for output of function `sparseLTS()` in package `robustHD`.](https://github.com/aalfons/robustHD/blob/master/inst/doc/paper/figure_sparseLTS.pdf?raw=true){width=67%}
...
![Examples of the coefficient plot (*left*), the optimality criterion plot (*center*), and the regression diagnostic plot (*right*) for output of function `rgrplars()` in package `robustHD`.\label{fig:rgrplars}](https://github.com/aalfons/robustHD/blob/master/inst/doc/paper/figure_rgrplars.pdf?raw=true){width=100%}
