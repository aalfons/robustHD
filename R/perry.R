...
#' \item{pe}{a numeric vector containing the estimated prediction errors
#' for the requested model fits.  In case of more than one replication, this
#' gives the average value over all replications.}
#' \item{se}{a numeric vector containing the estimated standard errors of
#' the prediction loss for the requested model fits.}
#' \item{reps}{a numeric matrix in which each column contains the
...
#' \item{splits}{an object giving the data splits used to estimate the
#' prediction error.}
#' \item{y}{the response.}
#' \item{yHat}{a list containing the predicted values from all
#' replications.}
