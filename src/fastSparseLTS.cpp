...
class Subset {
  ...
  // perform C-Step
  void cStep(const mat&, const vec&, const double&, const bool&, const bool&,
...
SEXP R_testLasso(SEXP R_x, SEXP R_y, SEXP R_lambda, SEXP R_initial,
                 SEXP R_normalize, SEXP R_intercept, SEXP R_eps,
                 SEXP R_useGram) {
...
SEXP R_testCStep(SEXP R_x, SEXP R_y, SEXP R_lambda, SEXP R_subset,
                 SEXP R_normalize, SEXP R_intercept, SEXP R_tol,
...
Subset fastSparseLTS(const mat& x, const vec& y, const double& lambda,
                     const umat& initial, const bool& normalize,
                     const bool& useIntercept, const int& ncstep,
                     int& nkeep, const double& tol, const double& eps,
                     const bool& useGram, int& ncores, double& center,
                     double& scale) {
  // initializations
...
SEXP R_fastSparseLTS(SEXP R_x, SEXP R_y, SEXP R_lambda, SEXP R_initial,
  ...
  Subset best = fastSparseLTS(x, y, lambda, initial, normalize, useIntercept,
                              ncstep, nkeep, tol, eps, useGram, ncores, center,
                              scale);
  // return results as list
